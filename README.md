...
[![Go Report Card](https://goreportcard.com/badge/github.com/canecat/gin-swagger)](https://goreportcard.com/report/github.com/canecat/gin-swagger)
[![GoDoc](https://godoc.org/github.com/canecat/gin-swagger?status.svg)](https://godoc.org/github.com/canecat/gin-swagger)
...
$ swag init
```
4. Download [gin-swagger](https://github.com/canecat/gin-swagger) by using:
```sh
